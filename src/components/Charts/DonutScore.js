    ...
    <div className="bg-white  p-3 flex items-center ">
      ...
      <div className="flex flex-col gap-1 flex-1">
        <div>
          ...
          <p className="text-blue-700 font-semibold text-sm mb-0">
        ...
        <div>
          ...
          <p className="text-blue-700 font-semibold text-sm">{vehicleScore}</p>
        </div>
        <div>
          ...
          <p className="text-blue-700 font-semibold text-sm">
            {behaviourScore} <span className="text-gray-500">(Assessment Year 2024)</span>
          </p>
        </div>
      </div>
